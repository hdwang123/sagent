...
class HandlerTest {
    ...
    void chatHandler_type() {
        ChatHandler handler = new ChatHandler(mockBuilder, mockAdvisor, mock(CostMonitorService.class));
    ...
    void skillHandler_type() {
        ...
        SkillHandler handler = new SkillHandler(mockBuilder, mockAdvisor, List.of(), mockMapper, mock(CostMonitorService.class));
    ...
    void gskillHandler_type() {
        GSkillHandler handler = new GSkillHandler(mockBuilder, mockAdvisor, List.of(), mock(CostMonitorService.class));
    ...
    void askillHandler_type() {
        ...
        ASkillHandler handler = new ASkillHandler(mockBuilder, mockAdvisor, List.of(), mockResolver, mock(CostMonitorService.class));
    ...
    void mcpHandler_type() {
        McpHandler handler = new McpHandler(mockBuilder, mockAdvisor, "http://localhost:8081/mcp", mock(CostMonitorService.class));
    ...
    void ragHandler_type() {
        ...
        RagHandler handler = new RagHandler(mockBuilder, mockAdvisor, mockRetriever, mockHistory, mockChatModel, 10, 3, mock(CostMonitorService.class));
