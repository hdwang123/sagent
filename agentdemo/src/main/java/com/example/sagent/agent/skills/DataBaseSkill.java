...
public class DataBaseSkill implements GSkill {
    ...
    @AuditLog(operationType = OperationType.PRODUCT_QUERY, resourceType = ResourceType.PRODUCT,
            resourceId = "listProducts", operationDetail = "查询全部产品")
    ...
    @AuditLog(operationType = OperationType.PRODUCT_QUERY, resourceType = ResourceType.PRODUCT,
            resourceId = "findProductsByName", operationDetail = "按名称模糊查询产品")
    ...
    @AuditLog(operationType = OperationType.PRODUCT_QUERY, resourceType = ResourceType.PRODUCT,
            resourceId = "findProductsByMaxPrice", operationDetail = "按最高价格查询产品")
    ...
    @AuditLog(operationType = OperationType.PRODUCT_QUERY, resourceType = ResourceType.PRODUCT,
            resourceId = "findProductById", operationDetail = "按ID查询单个产品")
    ...
    @AuditLog(operationType = OperationType.PRODUCT_QUERY, resourceType = ResourceType.PRODUCT,
            resourceId = "countProducts", operationDetail = "统计产品总数")
